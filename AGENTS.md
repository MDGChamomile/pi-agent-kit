...
- For reviews and diagnosis, prioritize well-supported, actionable findings over finding count. Finding no material issue is a valid outcome. Distinguish confirmed defects from speculative risks, treat inability to verify as uncertainty rather than evidence, and reassess unchanged code only when new evidence warrants it.
